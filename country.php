...
<?php 
  ...
  if($current_page > 1) {
      $prev = $current_page - 1;
      $params = isset($_GET["searccountry"]) ? "searccountry=$SearchCountryName&" : "";
      $pagination .= "<a href='country.php?{$params}bn=$prev'>&laquo; Back</a>";
  } else {
  ...
  for($i = $start_page; $i <= $end_page; $i++) {
      ...
      $pagination .= "<a class='$active' href='country.php?{$params}bn=$i'>$i</a>";
  }
  ...
  if($current_page < $number_of_row) {
      $next = $current_page + 1;
      $params = isset($_GET["searccountry"]) ? "searccountry=$SearchCountryName&" : "";
      $pagination .= "<a href='country.php?{$params}bn=$next'>Next &raquo;</a>";
  } else {
